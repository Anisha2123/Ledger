...
export const TRANSACTIONS = [
  ...
  tx('t017', '2026-02-02', 'Apartment Rent', -18000, 'rent', 'expense'),
  tx('t018', '2026-02-04', 'Grocery Store', -2750, 'food', 'expense'),
  tx('t019', '2026-02-06', 'Metro Pass', -500, 'transport', 'expense'),
  tx('t020', '2026-02-07', 'Movie Tickets', -820, 'entertainment', 'expense'),
  tx('t021', '2026-02-09', 'Doctor Visit', -600, 'health', 'expense'),
  tx('t022', '2026-02-10', 'Freelance Project C', 15000, 'freelance', 'income'),
  tx('t023', '2026-02-12', 'Clothing Purchase', -4500, 'shopping', 'expense'),
  tx('t024', '2026-02-14', 'Valentine Dinner', -2200, 'food', 'expense'),
  tx('t025', '2026-02-16', 'Electricity Bill', -1100, 'utilities', 'expense'),
  tx('t026', '2026-02-18', 'Spotify', -119, 'entertainment', 'expense'),
  tx('t027', '2026-02-20', 'Petrol', -1900, 'transport', 'expense'),
  tx('t028', '2026-02-22', 'Pharmacy', -340, 'health', 'expense'),
  tx('t029', '2026-02-25', 'Investment - Stocks', -5000, 'investment', 'expense'),
  tx('t030', '2026-02-28', 'Miscellaneous', -750, 'other', 'expense'),

  // March
  tx('t031', '2026-03-01', 'Monthly Salary', 85000, 'salary', 'income'),
  tx('t032', '2026-03-02', 'Apartment Rent', -18000, 'rent', 'expense'),
  tx('t033', '2026-03-03', 'Grocery Store', -3100, 'food', 'expense'),
  tx('t034', '2026-03-05', 'Holi Celebrations', -1800, 'entertainment', 'expense'),
  tx('t035', '2026-03-07', 'Uber Ride', -340, 'transport', 'expense'),
  tx('t036', '2026-03-08', 'Freelance Project D', 22000, 'freelance', 'income'),
  tx('t037', '2026-03-10', 'Online Course', -2999, 'other', 'expense'),
  tx('t038', '2026-03-12', 'Restaurant Lunch', -680, 'food', 'expense'),
  tx('t039', '2026-03-14', 'Electricity Bill', -1350, 'utilities', 'expense'),
  tx('t040', '2026-03-16', 'Shopping Mall', -5200, 'shopping', 'expense'),
  tx('t041', '2026-03-18', 'Gym Membership', -1500, 'health', 'expense'),
  tx('t042', '2026-03-20', 'Investment - Mutual Fund', -10000, 'investment', 'expense'),
  tx('t043', '2026-03-22', 'Petrol', -2300, 'transport', 'expense'),
  tx('t044', '2026-03-25', 'Mobile Recharge', -399, 'utilities', 'expense'),
  tx('t045', '2026-03-28', 'Dinner Party', -1200, 'food', 'expense'),

  // April
  tx('t046', '2026-04-01', 'Monthly Salary', 90000, 'salary', 'income', 'Increment'),
  tx('t047', '2026-04-02', 'Apartment Rent', -18000, 'rent', 'expense'),
